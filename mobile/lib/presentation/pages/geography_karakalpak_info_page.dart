...
/// Qoraqalpogʻiston Respublikasi — «Dunyo xaritasi» boʻlimidagi qisqa maʼlumot sahifasi.
class GeographyKarakalpakInfoPage extends StatelessWidget {
  const GeographyKarakalpakInfoPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.tr('geo_karakalpak_title')),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  context.tr('geo_karakalpak_capital'),
                  style: TextStyle(
                    fontSize: 15,
          ...
          Text(
            context.tr('geo_karakalpak_intro'),
            style: TextStyle(
              fontSize: 16,
              height: 1.55,
              color: primaryText,
            ...
            child: Column(
              children: [
                GeoStatRow(
                  ...
                  value: context.tr('geo_karakalpak_v_area'),
                  secondary: secondary,
                ...
                GeoStatRow(
                  ...
                  value: context.tr('geo_karakalpak_v_pop'),
                  secondary: secondary,
                  primaryText: primaryText,
                ),
                geoStatDivider(isDark),
                GeoStatRow(
                  ...
                  value: context.tr('geo_karakalpak_v_lang'),
                  secondary: secondary,
                  primaryText: primaryText,
                ),
                geoStatDivider(isDark),
                GeoStatRow(
                  ...
                  value: context.tr('geo_karakalpak_v_currency'),
                  secondary: secondary,
                  primaryText: primaryText,
                ),
                geoStatDivider(isDark),
                GeoStatRow(
                  label: context.tr('geo_karakalpak_border_label'),
                  value: context.tr('geo_karakalpak_v_border'),
                  secondary: secondary,
                  primaryText: primaryText,
                  isLast: true,
                ),
          ...
          const GeographyTopicCompleteBar(
            topicId: 'geo_karakalpakstan',
            titleTrKey: 'geo_karakalpak_title',
          ),
        ],
      ),
    );
