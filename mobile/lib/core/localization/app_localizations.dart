...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'uz': {
      ...
      'menu_videos': 'Videolar',
      'menu_3d_models': '3D Modellar',
      'three_d_models_empty': 'Hozircha 3D model mavjud emas',
      'three_d_model_detail': '3D Model',
      'three_d_model_no_file': 'Fayl yuklanmagan',
      'menu_lab_works': 'Laboratoriya ishlari',
      'videos_empty': 'Hali hech qanday video joylashtirilmagan',
      'video_details': 'Video',
      'videos_channel_default': 'Kimyo kanali',
      'show_more': 'Yana',
      'show_less': 'Kamroq',
      'tests_title': 'Testlar',
    ...
    'ru': {
      ...
      'menu_videos': 'Видео',
      'menu_3d_models': '3D Модели',
      'three_d_models_empty': '3D модели пока недоступны',
      'three_d_model_detail': '3D Модель',
      'three_d_model_no_file': 'Файл не загружен',
      'videos_empty': 'Видео ещё не загружены',
      'video_details': 'Видео',
      'videos_channel_default': 'Канал химии',
      'show_more': 'Ещё',
      'show_less': 'Свернуть',
    ...
    'en': {
      ...
      'menu_quiz': 'Take Quiz',
      'menu_videos': 'Videos',
      'menu_3d_models': '3D Models',
      'three_d_models_empty': 'No 3D models available yet',
      'three_d_model_detail': '3D Model',
      'three_d_model_no_file': 'File not uploaded',
      'menu_lab_works': 'Laboratory Works',
      'videos_empty': 'No videos have been uploaded yet',
      'video_details': 'Video',
      'videos_channel_default': 'Chemistry channel',
      'show_more': 'Show more',
      'show_less': 'Show less',
      'tests_title': 'Tests',
